 ...
 */
class Client extends \Esprit\DemoBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'adressmail', 'banir', 'login', 'motdepasse', 'nom', 'numtel', 'prenom', 'id');
        }
